...
yandex_conference_table = sa.Table(
    "yandex_conference",
    metadata_obj,
    sa.Column("cal_id", sa.ForeignKey("yandex_calendar.cal_id", onupdate="CASCADE", ondelete="CASCADE"), nullable=False),
    sa.Column('uid', sa.String, primary_key=True),
    sa.Column('timezone', sa.String, nullable=False),
    sa.Column('dtstart', sa.String, nullable=False),
    sa.Column('dtend', sa.String, nullable=False),
    ...
    sa.Column('x_telemost_conference', sa.String),
